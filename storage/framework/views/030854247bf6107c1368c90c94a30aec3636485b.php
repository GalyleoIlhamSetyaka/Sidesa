                ...
                <?php if($dokumen['satuan']): ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <i class="fa fa-file-pdf-o pop-up-pdf" aria-hidden="true" style="font-size: 60px;" data-title="Berkas <?php echo e($dokumen['nomor_surat']); ?>" data-url="<?php echo e(site_url("{$controller}/berkas/{$dokumen['id']}/1/1")); ?>"></i>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sidesa\resources\views/admin/dokumen/buku_kades/form.blade.php ENDPATH**/ ?>
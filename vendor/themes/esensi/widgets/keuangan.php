        ...
        <div x-data="{
          ...
          <div x-ref="panel" x-show="open" x-transition.origin.top.left x-on:click.outside="close($refs.button)"
            ...
            <ul class="divide-y text-base font-normal">
              ...
              <li><a href="#!" class="py-2 px-3 block" @click="close($refs.button); gantiTipe('pelaksanaan'); gantiTahun('<?= $key ?>')">Pelaksanaan APBDes</a></li>
              <li><a href="#!"  class="py-2 px-3 block" @click="close($refs.button); gantiTipe('pendapatan'); gantiTahun('<?= $key ?>')">Pendapatan APBDes</a></li>
              <li><a href="#!" class="py-2 px-3 block" @click="close($refs.button); gantiTipe('belanja'); gantiTahun('<?= $key ?>')">Belanja APBDes</a></li>
              <?php endforeach;?>
            </ul>
          </div>
        </div>

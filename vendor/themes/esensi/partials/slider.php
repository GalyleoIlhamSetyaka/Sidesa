...
<section class="sliderx w-full relative group transition-all duration-300 overflow-hidden h-[400px] lg:h-[480px]">
  <div class="owl-carousel rounded-lg relative w-full h-full">
